...
adminRouter.route('/canApproveWorkshop').get((req, res) => new admin_controller_1.AdminController().canApproveWorkshop(req, res));
adminRouter.route('/approveProposal').post((req, res) => new admin_controller_1.AdminController().approveProposal(req, res));
adminRouter.route('/rejectProposal').post((req, res) => new admin_controller_1.AdminController().rejectProposal(req, res));

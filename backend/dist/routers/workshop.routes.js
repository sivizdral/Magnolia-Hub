...
workshopRouter.route('/update').post(upload.array('photo', 1), (req, res) => new workshop_controller_1.WorkshopController().update(req, res));
...
workshopRouter.route('/pastUserWorkshops').get((req, res) => new workshop_controller_1.WorkshopController().pastUserWorkshops(req, res));
workshopRouter.route('/acceptApplication').post((req, res) => new workshop_controller_1.WorkshopController().acceptApplication(req, res));
workshopRouter.route('/rejectApplication').post((req, res) => new workshop_controller_1.WorkshopController().rejectApplication(req, res));
workshopRouter.route('/pendingApplicants').get((req, res) => new workshop_controller_1.WorkshopController().pendingApplicants(req, res));

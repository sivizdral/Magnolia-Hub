...
actionsRouter.route('/allUserLikes').get((req, res) => new action_controller_1.ActionController().allUserLikes(req, res));
...
actionsRouter.route('/allUserComments').get((req, res) => new action_controller_1.ActionController().allUserComments(req, res));
actionsRouter.route('/comment').post((req, res) => new action_controller_1.ActionController().postComment(req, res));
actionsRouter.route('/removeComment').post((req, res) => new action_controller_1.ActionController().removeComment(req, res));
